...
<summary> Cada una de ellas. </summary>
<ul>
<div>Reducción de residuos:
<li> Las 7R ayudan a minimizar la cantidad de residuos generados en la escuela, lo que reduce el impacto ambiental.  </li>
<div>Ahorro de recursos:
<li> Al reutilizar, reparar y reciclar materiales, la escuela ahorra dinero y recursos. </li>
<div>Educación ambiental:
<li> Las 7R promueven una cultura de cuidado ambiental entre los estudiantes y el personal de la escuela. </li>
<div>Fomento de la creatividad:
<li> Las 7R pueden ser una fuente de inspiración para proyectos artísticos y educativos. </li>
<div>Desarrollo de habilidades:
<li>La aplicación de las 7R puede ayudar a los estudiantes a desarrollar habilidades de resolución de problemas, creatividad y trabajo en equipo. </li>
</details>
<Imagen con pie de foto>
<figure style="text-align: center; margin: 20px auto;">
<img src="reciclaje.jpg" alt="Diagrama de las 7R del reciclaje" width="400" style="border-radius: 8px;">
...
<table border="1" style="width: 80%; margin: auto; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 14px; background-color: #ffffff;">
...
<Imagen con pie de foto>
<figure style="text-align: center; margin: 20px auto;">
<img src="cartel 7r-2.png" alt="Cartel 7-R" width="400" style="border-radius: 8px;">
